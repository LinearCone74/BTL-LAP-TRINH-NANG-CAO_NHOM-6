...
public class AuctionView extends Entity {
    ...
    // Các field này dùng cho màn hình bảng khi dữ liệu lấy trực tiếp từ database.
    ...
    public AuctionView(Item item, LocalDateTime startTime, LocalDateTime endTime) {
        if (item == null) {
    ...
    // Constructor dùng để hiển thị dữ liệu lên TableView từ bảng auctions trong database.
    public AuctionView(int auctionId,
        ...
        this.id = String.valueOf(auctionId);
    }
    ...
    public String getDescription() {
        return description != null ? description : item.getDescription();
    }
    ...
    public String getSellerName() {
        ...
        return item.getSeller() == null ? "" : item.getSeller().getUsername();
    }
